...
class ShiftService:
    ...
    def parse_google_sheet(self, google_link: str, month: int):
        ...
        employee_preferences = EmployeePreferences(employee_id = data[0][0], preferences= self._get_preferences_from_data_table(data))
    ...
    def _get_preferences_from_data_table(self, data_table: list):
        preferences_list = []
        self.month, self.year = self._parse_sheet_name_to_ints(self.sheet_name)
...
if __name__ == "__main__":
    emmaz = ShiftService()
    tomerz = emmaz.parse_google_sheet("https://docs.google.com/spreadsheets/d/1iCGT15DFkr7W93_pfUWME4yUO_byj18N1hZ9zmnGAMA/edit?gid=0#gid=0", 6)
    print(tomerz)